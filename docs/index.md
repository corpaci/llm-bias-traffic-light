...
**BBQ** dataset across **11 bias categories** (including intersectional ones) and renders a
green / yellow / red "traffic light" verdict.
...
- [Configuration Guide](CONFIG_GUIDE.html)
- [Running Experiments](EXPERIMENT_GUIDE.html)
- [Extending the Tool](EXTENDING.html)

## Source

[github.com/corpaci/llm-bias-traffic-light](https://github.com/corpaci/llm-bias-traffic-light)
